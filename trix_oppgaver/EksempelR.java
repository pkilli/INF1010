...
class EksempelR  {
	...
	*/
	...
	test("Tester hasNext() naar lista er toemt.", false, li.hasNext() );
...
class Katt implements Comparable<Katt> {
	...
	return "Katteobjekt med navn = <<" + navn + ">>";
    }
...
class Lenkeliste<T> implements Iterable<T> {
    ...
    Lenkeliste() {
	lh = new Node(null);
	// lh.neste peker naa paa det foran foer pekte paa
    }
	...
	public void remove() {
		...
		tilstand = TILSTAND_A;
	    } else System.out.println("Feil kall paa remove()");
	}	
